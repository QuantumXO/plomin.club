...
<header>
	...
	@@include('blocks/_header-slider.html')
</header>

<main>
	@@include('blocks/_whowe.html')
	@@include('blocks/_events.html')
		...
		<div class="row clearfix">
			<div class="main_gallery-tabs" id="mainGalleryTabs">
				...
				<div id="mainGalleryTab-1" class="main_gallery-photo main_gallery-slider">
					@@include('blocks/_main_photo-gallery.html')
				</div>
				<div id="mainGalleryTab-2" class="main_gallery-video main_gallery-slider">
					@@include('blocks/_main_video-gallery.html')
				</div>
			</div>
